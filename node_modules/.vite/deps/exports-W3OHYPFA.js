  ...
  createClients() {
    this.connectionControllerClient = {
      ...
      disconnect: async (params) => {
        ...
        const isAuth = connectorId === ConstantsUtil.CONNECTOR_ID.AUTH || currentConnectorId === ConstantsUtil.CONNECTOR_ID.AUTH;
        const isWalletConnect = connectorId === ConstantsUtil.CONNECTOR_ID.WALLET_CONNECT || currentConnectorId === ConstantsUtil.CONNECTOR_ID.WALLET_CONNECT;
        try {
          ...
          const disconnectPromises = namespacesToDisconnect.map(async (ns) => {
            ...
            if (initialDisconnect && isAuth) {
              ...
              namespacesToDisconnect.forEach((ns2) => {
                StorageUtil.addDisconnectedConnectorId(connectorIdToUse || "", ns2);
              });
            }
      ...
      this.chainNamespaces.forEach((namespace) => {
        WcHelpersUtil.listenWcProvider({
          ...
          onChainChanged: (chainId) => {
            ...
            const isCurrentConnectorWalletConnect = ConnectorController.state.activeConnectorIds[activeNamespace] === ConstantsUtil.CONNECTOR_ID.WALLET_CONNECT;
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-BNJG7YV5.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-74C6XSYV.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-LQWIW46D.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-GU7SUFFZ.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-TQZBCM6S.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-BNX3UDV6.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-J7I3YPNT.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-HBIFGMQP.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-BUHEFUUA.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-HMFUVXG5.js"),
      import("./w3m-modal-S7WPZGOW.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.11";
...
//# sourceMappingURL=exports-W3OHYPFA.js.map
