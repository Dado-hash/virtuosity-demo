...
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-2MTVQP3P.js";
import {
  esm_exports,
  require_cjs,
  require_cjs2,
  require_cjs3
} from "./chunk-AZA4FIUK.js";
import {
  require_events
} from "./chunk-UW7JWTTR.js";
import {
  formatUnits
} from "./chunk-BH5JLOB6.js";
import {
  __toESM
...
function Zi(t, e = 24) {
  ...
  for (let r2 = 24 - e; r2 < 24; r2++) {
    ...
    for (let s = 0; s < 10; s += 2) {
      const c = (s + 8) % 10, a = (s + 2) % 10, u = n2[a], l2 = n2[a + 1], f4 = rr(u, l2, 1) ^ n2[c], h3 = or(u, l2, 1) ^ n2[c + 1];
      for (let y3 = 0; y3 < 50; y3 += 10) t[s + y3] ^= f4, t[s + y3 + 1] ^= h3;
    }
    let o2 = t[2], i2 = t[3];
    for (let s = 0; s < 24; s++) {
      const c = er[s], a = rr(o2, i2, c), u = or(o2, i2, c), l2 = tr[s];
      o2 = t[l2], i2 = t[l2 + 1], t[l2] = a, t[l2 + 1] = u;
    }
...
var En = class _En extends ke {
  constructor(e, n2, r2, o2 = false, i2 = 24) {
    if (super(), this.blockLen = e, this.suffix = n2, this.outputLen = r2, this.enableXOF = o2, this.rounds = i2, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, Wt(r2), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
  ...
  update(e) {
    ...
    for (let i2 = 0; i2 < o2; ) {
      ...
      for (let c = 0; c < s; c++) r2[this.pos++] ^= e[i2++];
  ...
  _cloneInto(e) {
    ...
    return e || (e = new _En(n2, r2, o2, s, i2)), e.state32.set(this.state32), e.pos = this.pos, e.posOut = this.posOut, e.finished = this.finished, e.rounds = i2, e.suffix = r2, e.outputLen = o2, e.enableXOF = s, e.destroyed = this.destroyed, e;
  }
};
...
function Ir(t, e, n2, r2) {
  ...
  const o2 = BigInt(32), i2 = BigInt(4294967295), s = Number(n2 >> o2 & i2), c = Number(n2 & i2), a = r2 ? 4 : 0, u = r2 ? 0 : 4;
  t.setUint32(e + a, s, r2), t.setUint32(e + u, c, r2);
}
function vs(t) {
...
function Is(t, e, n2, r2, o2, i2, s, c) {
  const a = o2.length, u = new Uint8Array(ge), l2 = mt(u), f4 = Ye(o2) && Ye(i2), h3 = f4 ? mt(o2) : Tr, y3 = f4 ? mt(i2) : Tr;
  for (let E2 = 0; E2 < a; s++) {
    ...
    for (let d2 = 0, v; d2 < p; d2++) v = E2 + d2, i2[v] = o2[v] ^ u[d2];
    E2 += p;
  }
}
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i2), Ar(n2), (c, a, u, l2, f4 = 0) => {
    tt(c), tt(a), tt(u);
    const h3 = u.length;
    if (l2 === void 0 && (l2 = new Uint8Array(h3)), tt(l2), Fe(f4), f4 < 0 || f4 >= Ur) throw new Error("arx: counter overflow");
    ...
    if (m2 !== 12) {
      ...
      N.set(a, i2 ? 0 : 12 - a.length), a = N, y3.push(a);
    }
    const O2 = mt(a);
    return Is(t, d2, v, O2, u, l2, f4, s), jt(...y3), l2;
  };
}
...
var Us = class {
  constructor(e) {
    ...
    const n2 = F(e, 0), r2 = F(e, 2), o2 = F(e, 4), i2 = F(e, 6), s = F(e, 8), c = F(e, 10), a = F(e, 12), u = F(e, 14);
    this.r[0] = n2 & 8191, this.r[1] = (n2 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | i2 << 9) & 8191, this.r[4] = (i2 >>> 4 | s << 12) & 255, this.r[5] = s >>> 1 & 8190, this.r[6] = (s >>> 14 | c << 2) & 8191, this.r[7] = (c >>> 11 | a << 5) & 8065, this.r[8] = (a >>> 8 | u << 8) & 8191, this.r[9] = u >>> 5 & 127;
    for (let l2 = 0; l2 < 8; l2++) this.pad[l2] = F(e, 16 + 2 * l2);
  }
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i2, r: s } = this, c = s[0], a = s[1], u = s[2], l2 = s[3], f4 = s[4], h3 = s[5], y3 = s[6], E2 = s[7], p = s[8], d2 = s[9], v = F(e, n2 + 0), m2 = F(e, n2 + 2), O2 = F(e, n2 + 4), N = F(e, n2 + 6), $ = F(e, n2 + 8), B3 = F(e, n2 + 10), A2 = F(e, n2 + 12), T = F(e, n2 + 14);
    let S2 = i2[0] + (v & 8191), L = i2[1] + ((v >>> 13 | m2 << 3) & 8191), U4 = i2[2] + ((m2 >>> 10 | O2 << 6) & 8191), _ = i2[3] + ((O2 >>> 7 | N << 9) & 8191), j = i2[4] + ((N >>> 4 | $ << 12) & 8191), g = i2[5] + ($ >>> 1 & 8191), w = i2[6] + (($ >>> 14 | B3 << 2) & 8191), b = i2[7] + ((B3 >>> 11 | A2 << 5) & 8191), I2 = i2[8] + ((A2 >>> 8 | T << 8) & 8191), R3 = i2[9] + (T >>> 5 | o2), x = 0, C4 = x + S2 * c + L * (5 * d2) + U4 * (5 * p) + _ * (5 * E2) + j * (5 * y3);
    x = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h3) + w * (5 * f4) + b * (5 * l2) + I2 * (5 * u) + R3 * (5 * a), x += C4 >>> 13, C4 &= 8191;
    let P3 = x + S2 * a + L * c + U4 * (5 * d2) + _ * (5 * p) + j * (5 * E2);
    x = P3 >>> 13, P3 &= 8191, P3 += g * (5 * y3) + w * (5 * h3) + b * (5 * f4) + I2 * (5 * l2) + R3 * (5 * u), x += P3 >>> 13, P3 &= 8191;
    let k2 = x + S2 * u + L * a + U4 * c + _ * (5 * d2) + j * (5 * p);
    x = k2 >>> 13, k2 &= 8191, k2 += g * (5 * E2) + w * (5 * y3) + b * (5 * h3) + I2 * (5 * f4) + R3 * (5 * l2), x += k2 >>> 13, k2 &= 8191;
    let M3 = x + S2 * l2 + L * u + U4 * a + _ * c + j * (5 * d2);
    x = M3 >>> 13, M3 &= 8191, M3 += g * (5 * p) + w * (5 * E2) + b * (5 * y3) + I2 * (5 * h3) + R3 * (5 * f4), x += M3 >>> 13, M3 &= 8191;
    let D = x + S2 * f4 + L * l2 + U4 * u + _ * a + j * c;
    x = D >>> 13, D &= 8191, D += g * (5 * d2) + w * (5 * p) + b * (5 * E2) + I2 * (5 * y3) + R3 * (5 * h3), x += D >>> 13, D &= 8191;
    let z = x + S2 * h3 + L * f4 + U4 * l2 + _ * u + j * a;
    x = z >>> 13, z &= 8191, z += g * c + w * (5 * d2) + b * (5 * p) + I2 * (5 * E2) + R3 * (5 * y3), x += z >>> 13, z &= 8191;
    let Z2 = x + S2 * y3 + L * h3 + U4 * f4 + _ * l2 + j * u;
    x = Z2 >>> 13, Z2 &= 8191, Z2 += g * a + w * c + b * (5 * d2) + I2 * (5 * p) + R3 * (5 * E2), x += Z2 >>> 13, Z2 &= 8191;
    let st2 = x + S2 * E2 + L * y3 + U4 * h3 + _ * f4 + j * l2;
    x = st2 >>> 13, st2 &= 8191, st2 += g * u + w * a + b * c + I2 * (5 * d2) + R3 * (5 * p), x += st2 >>> 13, st2 &= 8191;
    let W = x + S2 * p + L * E2 + U4 * y3 + _ * h3 + j * f4;
    x = W >>> 13, W &= 8191, W += g * l2 + w * u + b * a + I2 * c + R3 * (5 * d2), x += W >>> 13, W &= 8191;
    let J2 = x + S2 * d2 + L * p + U4 * E2 + _ * y3 + j * h3;
    x = J2 >>> 13, J2 &= 8191, J2 += g * f4 + w * l2 + b * u + I2 * a + R3 * c, x += J2 >>> 13, J2 &= 8191, x = (x << 2) + x | 0, x = x + C4 | 0, C4 = x & 8191, x = x >>> 13, P3 += x, i2[0] = C4, i2[1] = P3, i2[2] = k2, i2[3] = M3, i2[4] = D, i2[5] = z, i2[6] = Z2, i2[7] = st2, i2[8] = W, i2[9] = J2;
  }
  finalize() {
    ...
    r2[9] -= 8192;
    let i2 = (o2 ^ 1) - 1;
    for (let c = 0; c < 10; c++) r2[c] &= i2;
    i2 = ~i2;
    for (let c = 0; c < 10; c++) e[c] = e[c] & i2 | r2[c];
...
var Cs = (t) => (e, n2, r2) => ({ encrypt(i2, s) {
  const c = i2.length;
  s = Br(c + 16, s, false), s.set(i2);
  const a = s.subarray(0, -16);
  t(e, n2, a, a, 1);
  const u = _r(t, e, n2, a, r2);
  return s.set(u, c), jt(u), s;
}, decrypt(i2, s) {
  s = Br(i2.length - 16, s, false);
  const c = i2.subarray(0, -16), a = i2.subarray(-16), u = _r(t, e, n2, c, r2);
  if (!bs(a, u)) throw new Error("invalid tag");
  return s.set(i2.subarray(0, -16)), t(e, n2, s, s, 1), jt(u), s;
} });
...
var Lr = class extends ke {
  ...
  _cloneInto(e) {
    ...
    const { oHash: n2, iHash: r2, finished: o2, destroyed: i2, blockLen: s, outputLen: c } = this;
    return e = e, e.finished = o2, e.destroyed = i2, e.blockLen = s, e.outputLen = c, e.oHash = n2._cloneInto(e.oHash), e.iHash = r2._cloneInto(e.iHash), e;
  }
  destroy() {
...
var qs = class extends ke {
  ...
  update(e) {
    ...
    const i2 = e.length;
    for (let s = 0; s < i2; ) {
      const c = Math.min(o2 - this.pos, i2 - s);
      if (c === o2) {
        const a = Pe(e);
  ...
  digestInto(e) {
    ...
    for (let f4 = s; f4 < o2; f4++) n2[f4] = 0;
    Ms(r2, o2 - 8, BigInt(this.length * 8), i2), this.process(r2, 0);
    const c = Pe(e), a = this.outputLen;
    if (a % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
    const u = a / 4, l2 = this.get();
    if (u > l2.length) throw new Error("_sha2: outputLen bigger than state");
    for (let f4 = 0; f4 < u; f4++) c.setUint32(4 * f4, l2[f4], i2);
  }
  digest() {
    const { buffer: e, outputLen: n2 } = this;
    this.digestInto(e);
  ...
  _cloneInto(e) {
    ...
    const { blockLen: n2, buffer: r2, length: o2, finished: i2, destroyed: s, pos: c } = this;
    return e.length = o2, e.pos = c, e.finished = i2, e.destroyed = s, o2 % n2 && e.buffer.set(r2), e;
  }
};
...
var Fs = class extends qs {
  ...
  get() {
    const { A: e, B: n2, C: r2, D: o2, E: i2, F: s, G: c, H: a } = this;
    return [e, n2, r2, o2, i2, s, c, a];
  }
  set(e, n2, r2, o2, i2, s, c, a) {
    this.A = e | 0, this.B = n2 | 0, this.C = r2 | 0, this.D = o2 | 0, this.E = i2 | 0, this.F = s | 0, this.G = c | 0, this.H = a | 0;
  }
  process(e, n2) {
    for (let f4 = 0; f4 < 16; f4++, n2 += 4) bt[f4] = e.getUint32(n2, false);
    for (let f4 = 16; f4 < 64; f4++) {
      const h3 = bt[f4 - 15], y3 = bt[f4 - 2], E2 = ct(h3, 7) ^ ct(h3, 18) ^ h3 >>> 3, p = ct(y3, 17) ^ ct(y3, 19) ^ y3 >>> 10;
      bt[f4] = p + bt[f4 - 7] + E2 + bt[f4 - 16] | 0;
    }
    let { A: r2, B: o2, C: i2, D: s, E: c, F: a, G: u, H: l2 } = this;
    for (let f4 = 0; f4 < 64; f4++) {
      const h3 = ct(c, 6) ^ ct(c, 11) ^ ct(c, 25), y3 = l2 + h3 + Ds(c, a, u) + Ks[f4] + bt[f4] | 0, p = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i2) | 0;
      l2 = u, u = a, a = c, c = s + y3 | 0, s = i2, i2 = o2, o2 = r2, r2 = y3 + p | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i2 = i2 + this.C | 0, s = s + this.D | 0, c = c + this.E | 0, a = a + this.F | 0, u = u + this.G | 0, l2 = l2 + this.H | 0, this.set(r2, o2, i2, s, c, a, u, l2);
  }
  roundClean() {
    bt.fill(0);
  }
...
function Vt(t) {
  ...
  for (let o2 = 0, i2 = 0; o2 < n2; o2++, i2 += 2) {
    const s = Cr(t.charCodeAt(i2)), c = Cr(t.charCodeAt(i2 + 1));
...
function Vr(t, e, n2) {
  ...
  let r2 = Qe(t), o2 = Qe(t), i2 = 0;
  const s = () => {
    r2.fill(1), o2.fill(0), i2 = 0;
  }, c = (...f4) => n2(o2, r2, ...f4), a = (f4 = Qe()) => {
    o2 = c(kr([0]), f4), r2 = c(), f4.length !== 0 && (o2 = c(kr([1]), f4), r2 = c());
  }, u = () => {
...
function Dt(t, e, n2 = {}) {
  const r2 = (o2, i2, s) => {
    ...
    const a = t[o2];
    if (!(s && a === void 0) && !c(a, t)) throw new Error("param " + String(o2) + " is invalid. Expected " + i2 + ", got " + a);
  };
...
function nn(t, e) {
  ...
  let n2 = X(t, e), r2 = e, o2 = q, i2 = H;
  for (; n2 !== q; ) {
    const c = r2 / n2, a = r2 % n2, u = o2 - i2 * c;
    r2 = n2, n2 = a, o2 = i2, i2 = u;
  }
...
function rc(t) {
  ...
  if (r2 === 1) {
    ...
    return function(a, u) {
      const l2 = a.pow(u, s);
      if (!a.eql(a.sqr(l2), u)) throw new Error("Cannot find square root");
      return l2;
    };
  }
  const i2 = (n2 + H) / At;
  return function(c, a) {
    ...
    let u = r2, l2 = c.pow(c.mul(c.ONE, o2), n2), f4 = c.pow(a, i2), h3 = c.pow(a, n2);
    for (; !c.eql(h3, c.ONE); ) {
      if (c.eql(h3, c.ZERO)) return c.ZERO;
      let y3 = 1;
      for (let p = c.sqr(h3); y3 < u && !c.eql(p, c.ONE); y3++) p = c.sqr(p);
      const E2 = c.pow(l2, H << BigInt(u - y3 - 1));
      l2 = c.sqr(E2), f4 = c.mul(f4, E2), h3 = c.mul(h3, l2), u = y3;
    }
    return f4;
  };
}
function oc(t) {
  ...
  if (t % Dr === Mr) {
    const e = (t - Mr) / Dr;
    return function(r2, o2) {
      const i2 = r2.mul(o2, At), s = r2.pow(i2, e), c = r2.mul(o2, s), a = r2.mul(r2.mul(c, At), s), u = r2.mul(c, r2.sub(a, r2.ONE));
      if (!r2.eql(r2.sqr(u), o2)) throw new Error("Cannot find square root");
      return u;
    };
  }
  return rc(t);
...
function ac(t, e) {
  const n2 = new Array(e.length), r2 = e.reduce((i2, s, c) => t.is0(s) ? i2 : (n2[c] = i2, t.mul(i2, s)), t.ONE), o2 = t.inv(r2);
  return e.reduceRight((i2, s, c) => t.is0(s) ? i2 : (n2[c] = t.mul(i2, n2[c]), t.mul(i2, s)), o2), n2;
}
function qr(t, e) {
...
function Kr(t, e, n2 = false, r2 = {}) {
  ...
  let s;
  const c = Object.freeze({ ORDER: t, isLE: n2, BITS: o2, BYTES: i2, MASK: Je(o2), ZERO: q, ONE: H, create: (a) => X(a, t), isValid: (a) => {
    if (typeof a != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a);
    return q <= a && a < t;
  }, is0: (a) => a === q, isOdd: (a) => (a & H) === H, neg: (a) => X(-a, t), eql: (a, u) => a === u, sqr: (a) => X(a * a, t), add: (a, u) => X(a + u, t), sub: (a, u) => X(a - u, t), mul: (a, u) => X(a * u, t), pow: (a, u) => cc(c, a, u), div: (a, u) => X(a * nn(u, t), t), sqrN: (a) => a * a, addN: (a, u) => a + u, subN: (a, u) => a - u, mulN: (a, u) => a * u, inv: (a) => nn(a, t), sqrt: r2.sqrt || ((a) => (s || (s = oc(t)), s(c, a))), invertBatch: (a) => ac(c, a), cmov: (a, u, l2) => l2 ? u : a, toBytes: (a) => n2 ? be(a, i2) : Mt(a, i2), fromBytes: (a) => {
...
function uc(t, e, n2 = false) {
  const r2 = t.length, o2 = Fr(e), i2 = zr(e);
...
function dc(t, e) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    let i2 = n2;
    for (; r2 > Zr; ) r2 & ve && (o2 = o2.add(i2)), i2 = i2.double(), r2 >>= ve;
    return o2;
  }, precomputeWindow(n2, r2) {
    const { windows: o2, windowSize: i2 } = on(r2, e), s = [];
    let c = n2, a = c;
    for (let u = 0; u < o2; u++) {
      a = c, s.push(a);
      for (let l2 = 1; l2 < i2; l2++) a = a.add(c), s.push(a);
      c = a.double();
    }
    return s;
  }, wNAF(n2, r2, o2) {
    ...
    const u = BigInt(2 ** n2 - 1), l2 = 2 ** n2, f4 = BigInt(n2);
    for (let h3 = 0; h3 < i2; h3++) {
      const y3 = h3 * s;
      let E2 = Number(o2 & u);
      o2 >>= f4, E2 > s && (E2 -= l2, o2 += ve);
      const p = y3, d2 = y3 + Math.abs(E2) - 1, v = h3 % 2 !== 0, m2 = E2 < 0;
      E2 === 0 ? a = a.add(rn(v, r2[p])) : c = c.add(rn(m2, r2[d2]));
    }
    return { p: c, f: a };
  }, wNAFUnsafe(n2, r2, o2, i2 = t.ZERO) {
    const { windows: s, windowSize: c } = on(n2, e), a = BigInt(2 ** n2 - 1), u = 2 ** n2, l2 = BigInt(n2);
    for (let f4 = 0; f4 < s; f4++) {
      const h3 = f4 * c;
      if (o2 === Zr) break;
      let y3 = Number(o2 & a);
      if (o2 >>= l2, y3 > c && (y3 -= u, o2 += ve), y3 === 0) continue;
    ...
    let i2 = sn2.get(r2);
    return i2 || (i2 = this.precomputeWindow(r2, n2), n2 !== 1 && sn2.set(r2, o2(i2))), i2;
  }, wNAFCached(n2, r2, o2) {
    const i2 = cn(n2);
...
function hc(t, e, n2, r2) {
  ...
  const o2 = t.ZERO, i2 = Pr(BigInt(n2.length)), s = i2 > 12 ? i2 - 3 : i2 > 4 ? i2 - 2 : i2 ? 2 : 1, c = (1 << s) - 1, a = new Array(c + 1).fill(o2), u = Math.floor((e.BITS - 1) / s) * s;
  let l2 = o2;
  for (let f4 = u; f4 >= 0; f4 -= s) {
    a.fill(o2);
    for (let y3 = 0; y3 < r2.length; y3++) {
      const E2 = r2[y3], p = Number(E2 >> BigInt(f4) & BigInt(c));
      a[p] = a[p].add(n2[y3]);
    }
    let h3 = o2;
    for (let y3 = a.length - 1, E2 = o2; y3 > 0; y3--) E2 = E2.add(a[y3]), h3 = h3.add(E2);
    if (l2 = l2.add(h3), f4 !== 0) for (let y3 = 0; y3 < s; y3++) l2 = l2.double();
  }
  return l2;
}
function Wr(t) {
...
function gc(t) {
  const e = pc(t), { P: n2 } = e, r2 = (m2) => X(m2, n2), o2 = e.montgomeryBits, i2 = Math.ceil(o2 / 8), s = e.nByteLength, c = e.adjustScalarBytes || ((m2) => m2), a = e.powPminus2 || ((m2) => Hr(m2, n2 - BigInt(2), n2));
  function u(m2, O2, N) {
    const $ = r2(m2 * (O2 - N));
  ...
  function f4(m2, O2) {
    ...
    for (let j = BigInt(o2 - 1); j >= Ht; j--) {
      const g = N >> j & an;
      L ^= g, U4 = u(L, B3, T), B3 = U4[0], T = U4[1], U4 = u(L, A2, S2), A2 = U4[0], S2 = U4[1], L = g;
    ...
    U4 = u(L, B3, T), B3 = U4[0], T = U4[1], U4 = u(L, A2, S2), A2 = U4[0], S2 = U4[1];
    const _ = a(A2);
    return r2(B3 * _);
  }
  function h3(m2) {
  ...
  function y3(m2) {
    const O2 = et("u coordinate", m2, i2);
...
BigInt(8);
function bc(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i2 = un, c = t * t % i2 * t % i2, a = it(c, Xr, i2) * c % i2, u = it(a, yc, i2) * t % i2, l2 = it(u, wc, i2) * u % i2, f4 = it(l2, e, i2) * l2 % i2, h3 = it(f4, n2, i2) * f4 % i2, y3 = it(h3, r2, i2) * h3 % i2, E2 = it(y3, o2, i2) * y3 % i2, p = it(E2, o2, i2) * y3 % i2, d2 = it(p, e, i2) * l2 % i2;
  return { pow_p_5_8: it(d2, Xr, i2) * t % i2, b2: c };
}
function Ec(t) {
...
var lt = { Err: Oc, _tlv: { encode: (t, e) => {
  ...
  const i2 = r2 > 127 ? kt(o2.length / 2 | 128) : "";
  return kt(t) + i2 + o2 + e;
}, decode(t, e) {
  const { Err: n2 } = lt;
  let r2 = 0;
  ...
  if (!i2) s = o2;
    ...
    const u = e.subarray(r2, r2 + a);
    if (u.length !== a) throw new n2("tlv.decode: length bytes not complete");
    if (u[0] === 0) throw new n2("tlv.decode(long): zero leftmost byte");
    for (const l2 of u) s = s << 8 | l2;
  ...
  const { v: c, l: a } = r2.decode(2, i2), { v: u, l: l2 } = r2.decode(2, a);
  if (l2.length) throw new e("invalid signature: left bytes after parsing");
  return { r: n2.decode(c), s: n2.decode(u) };
}, hexFromSig(t) {
  const { _tlv: e, _int: n2 } = lt, r2 = e.encode(2, n2.encode(t.r)), o2 = e.encode(2, n2.encode(t.s)), i2 = r2 + o2;
...
BigInt(4);
function Ac(t) {
  const e = vc(t), { Fp: n2 } = e, r2 = Kr(e.n, e.nBitLength), o2 = e.toBytes || ((p, d2, v) => {
  ...
  class h3 {
    ...
    static fromHex(d2) {
      const v = h3.fromAffine(i2(et("pointHex", d2)));
...
function Ic(t) {
  ...
  const { ProjectivePoint: a, normPrivateKeyToScalar: u, weierstrassEquation: l2, isWithinCurveOrder: f4 } = Ac({ ...e, toBytes(g, w, b) {
  ...
  class d2 {
    ...
    recoverPublicKey(w) {
      ...
      const P3 = (R3 & 1) === 0 ? "02" : "03", k2 = a.fromHex(P3 + h3(C4)), M3 = c(C4), D = s(-x * M3), z = s(I2 * M3), Z2 = a.BASE.multiplyAndAddUnsafe(k2, D, z);
  ...
  function O2(g) {
    ...
    return w ? I2 === o2 || I2 === i2 : b ? I2 === 2 * o2 || I2 === 2 * i2 : g instanceof a;
  }
  ...
  function S2(g, w, b = L) {
    ...
    const k2 = B3(g), M3 = u(w), D = [T(M3), T(k2)];
    if (P3 != null && P3 !== false) {
  ...
  function j(g, w, b, I2 = U4) {
    ...
    C4 && (w = e.hash(w));
    const { r: Z2, s: st2 } = D, W = B3(w), J2 = c(st2), Be3 = s(W * J2), zt = s(Z2 * J2), vt = (_a = a.BASE.multiplyAndAddUnsafe(z, Be3, zt)) == null ? void 0 : _a.toAffine();
...
function rr2(r2, e) {
  ...
  function d2(u) {
    ...
    for (var b = 0, x = 0, I2 = 0, D = u.length; I2 !== D && u[I2] === 0; ) I2++, b++;
    for (var j = (D - I2) * l2 + 1 >>> 0, T = new Uint8Array(j); I2 !== D; ) {
      for (var q2 = u[I2], J2 = 0, K2 = j - 1; (q2 !== 0 || J2 < x) && K2 !== -1; K2--, J2++) q2 += 256 * T[K2] >>> 0, T[K2] = q2 % a >>> 0, q2 = q2 / a >>> 0;
  ...
  function g(u) {
    ...
    var b = 0;
    if (u[b] !== " ") {
      for (var x = 0, I2 = 0; u[b] === c; ) x++, b++;
      for (var D = (u.length - b) * h3 + 1 >>> 0, j = new Uint8Array(D); u[b]; ) {
...
var Ee2 = ({ name: r2, prefix: e, encode: t, decode: i2 }) => new dr(r2, e, t, i2);
var de = ({ prefix: r2, name: e, alphabet: t }) => {
  const { encode: i2, decode: s } = or2(t, e);
  return Ee2({ prefix: r2, name: e, encode: i2, decode: (n2) => si2(s(n2)) });
};
var gr = (r2, e, t, i2) => {
  const s = {};
  ...
  for (let l2 = 0; l2 < n2; ++l2) {
    const d2 = s[r2[l2]];
    if (d2 === void 0) throw new SyntaxError(`Non-${i2} character`);
...
var P2 = ({ name: r2, prefix: e, bitsPerChar: t, alphabet: i2 }) => Ee2({ prefix: e, name: r2, encode(s) {
  return pr(s, i2, t);
}, decode(s) {
  return gr(s, i2, t, r2);
} });
...
function ai(r2, e, t) {
  e = e || [], t = t || 0;
  for (var i2 = t; r2 >= sn3; ) e[t++] = r2 & 255 | oi, r2 /= 128;
...
var Ke = (r2, e) => {
  ...
  return li2(r2, n2, 0), li2(t, n2, i2), n2.set(e, s), new mn(r2, t, e, n2);
};
var mn = class {
  constructor(e, t, i2, s) {
...
var fn2 = class {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return t instanceof Uint8Array ? Ke(this.code, t) : t.then((i2) => Ke(this.code, i2));
...
*/
//# sourceMappingURL=chunk-KDHD3PLH.js.map
