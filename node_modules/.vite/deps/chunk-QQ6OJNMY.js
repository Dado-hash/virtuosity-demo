import {
  keccak_256
} from "./chunk-C5D7SZFA.js";
import {
  HashMD
} from "./chunk-MY4QE62A.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-M3LLC7PC.js";
...
function base(ALPHABET2) {
  ...
  function encode3(source) {
    ...
    while (pbegin !== pend) {
      ...
      let i = 0;
      for (let it1 = size3 - 1; (carry !== 0 || i < length) && it1 !== -1; it1--, i++) {
        carry += 256 * b58[it1] >>> 0;
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i = 0;
      for (let it3 = size3 - 1; (carry !== 0 || i < length) && it3 !== -1; it3--, i++) {
...
//# sourceMappingURL=chunk-QQ6OJNMY.js.map
