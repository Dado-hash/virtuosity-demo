...
import {
  ...
  ad,
  m
} from "./chunk-WJ5TMJR3.js";
import "./chunk-4VU4W4JZ.js";
import "./chunk-65WYNJSY.js";
import "./chunk-PBT7R2LR.js";
...
// node_modules/@privy-io/wagmi/dist/esm/WagmiProvider.mjs
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);

// node_modules/@privy-io/wagmi/dist/esm/PrivyWagmiConnector.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);

// node_modules/@privy-io/wagmi/dist/esm/useSyncPrivyWallets.mjs
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-AKKUYJBH.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-MVHM3T3D.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-4UTALZDY.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-IRY62YMH.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-K2BDZMEE.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-YA6DT7PC.js");
...
// node_modules/@privy-io/wagmi/dist/esm/useSyncPrivyWallets.mjs
var s = ({ setActiveWalletForWagmi: a }) => {
  let { wallets: s2, ready: u } = ad(), { user: p } = Jy(), w = useConfig(), { reconnect: y } = useReconnect();
  W({ onSuccess: async ({ wallet: e5 }) => {
    var _a, _b;
    await ((_a = w.storage) == null ? void 0 : _a.removeItem(`${e5.meta.id}.disconnected`)), a || (await ((_b = w.storage) == null ? void 0 : _b.setItem("recentConnectorId", e5.meta.id)), y());
  } }), m({ onComplete: async ({ user: e5, loginAccount: t4 }) => {
    var _a;
    t4 && "wallet" !== t4.type && e5.linkedAccounts.find((e6) => "wallet" === e6.type && "privy" === e6.walletClientType) && (await ((_a = w.storage) == null ? void 0 : _a.removeItem("io.privy.wallet.disconnected")), y());
  } }), (0, import_react.useEffect)(() => {
    a && (async () => {
      let e5 = a({ wallets: s2, user: p });
      if (!e5) return l(w), void y();
      let [t4] = await d([e5], w);
      t4 ? (await m2(e5, t4, w), y()) : console.error(`Failed to setup connector for ${e5.address}`);
    })();
  }, [s2, p, a]), (0, import_react.useEffect)(() => {
    a || d(s2, w).then(() => {
      u && y();
    });
  }, [s2, !a, u]);
...
var d = async (e5, t4) => {
  let n3 = await Promise.all(e5.map(async (e6) => {
    let n4 = await e6.getEthereumProvider(), r3 = t4.connectors.find((t5) => t5.id === e6.meta.id);
    if (r3) return r3;
    let o2 = injected({ target: { provider: n4, id: e6.meta.id, name: e6.meta.name, icon: e6.meta.icon } });
    return t4._internal.connectors.setup(o2);
  }));
  return t4._internal.connectors.setState(n3), n3;
};
var l = (e5) => {
  e5._internal.connectors.setState([]), e5.setState((e6) => ({ chainId: e6.chainId, connections: /* @__PURE__ */ new Map(), current: null, status: "disconnected" }));
};
var m2 = async (e5, t4, n3) => {
  var _a, _b;
  await Promise.all([(_a = n3.storage) == null ? void 0 : _a.removeItem(`${e5.meta.id}.disconnected`), (_b = n3.storage) == null ? void 0 : _b.setItem("recentConnectorId", t4.id)]);
  let a = Number(e5.chainId.replace("eip155:", ""));
  n3.chains.find((e6) => e6.id === a) || (a = n3.chains[0].id);
  let r3 = /* @__PURE__ */ new Map([[t4.uid, { accounts: [e5.address], chainId: a, connector: t4 }]]);
  n3.setState((e6) => ({ ...e6, chainId: a, connections: r3, current: t4.uid, status: "connected" }));
};

// node_modules/@privy-io/wagmi/dist/esm/PrivyWagmiConnector.mjs
var import_react2 = __toESM(require_react(), 1);
var e2 = ({ children: e5, setActiveWalletForWagmi: o2 }) => (s({ setActiveWalletForWagmi: o2 }), (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: e5 }));

// node_modules/@privy-io/wagmi/dist/esm/WagmiProvider.mjs
var import_react3 = __toESM(require_react(), 1);
var o = ({ children: o2, setActiveWalletForWagmi: e5, ...m3 }) => (0, import_jsx_runtime2.jsx)(WagmiProvider, { reconnectOnMount: false, ...m3, children: (0, import_jsx_runtime2.jsx)(e2, { setActiveWalletForWagmi: e5, children: o2 }) });

// node_modules/@privy-io/wagmi/dist/esm/createConfig.mjs
var e3 = (e5) => {
  var _a;
  return createConfig({ ssr: true, ...e5, connectors: (_a = e5.connectors) == null ? void 0 : _a.filter((o2) => "mock" === o2.type), multiInjectedProviderDiscovery: false });
};

// node_modules/@privy-io/wagmi/dist/esm/useSetActiveWallet.mjs
var import_react4 = __toESM(require_react(), 1);
var n = () => {
  let { switchAccount: n3 } = useSwitchAccount(), { connect: r3 } = useConnect(), i = useConfig();
  return { setActiveWallet: (0, import_react4.useCallback)(async (t4) => {
    var _a;
    for (let e5 of i.connectors) if (e5.id === t4.meta.id && (await e5.getAccounts()).includes(t4.address)) return await ((_a = i.storage) == null ? void 0 : _a.removeItem(`${t4.meta.id}.disconnected`)), void (i.state.connections.get(e5.uid) ? n3({ connector: e5 }) : r3({ connector: e5 }));
  }, [i.connectors, i.state.connections, r3, n3]) };
};

// node_modules/@privy-io/wagmi/dist/esm/usePrivyWagmi.mjs
var import_react5 = __toESM(require_react(), 1);
var e4 = () => {
  let { setActiveWallet: e5 } = n();
  return { setActiveWallet: e5, activeWallet: void 0 };
};

// node_modules/@privy-io/wagmi/dist/esm/useEmbeddedSmartAccountConnector.mjs
var import_react6 = __toESM(require_react(), 1);
var n2 = ({ getSmartAccountFromSigner: n3 }) => {
  let a = useConnectors(), c = useConfig(), { reconnect: m3 } = useReconnect();
  (0, import_react6.useEffect)(() => {
    (async () => {
      var _a;
      if (a.find((t5) => "io.privy.smart_wallet" === t5.id)) return;
      let t4 = a.find((t5) => "io.privy.wallet" === t5.id);
      if (!t4) return;
      let r3 = await t4.getProvider(), e5 = injected({ target: { provider: await n3({ signer: r3 }), id: "io.privy.smart_wallet", name: "io.privy.smart_wallet", icon: "" } }), i = c._internal.connectors.setup(e5);
      c._internal.connectors.setState([i]), await ((_a = c.storage) == null ? void 0 : _a.setItem("recentConnectorId", i.id)), m3();
    })();
  }, [a, c, n3]);
};

// node_modules/@privy-io/wagmi/dist/esm/index.mjs
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var import_react7 = __toESM(require_react(), 1);
export {
  o as WagmiProvider,
  e3 as createConfig,
  n2 as useEmbeddedSmartAccountConnector,
  e4 as usePrivyWagmi,
  n as useSetActiveWallet
};
